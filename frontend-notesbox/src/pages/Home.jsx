...
function Home() {
  let homeCategories = [new Category(0, "Seasonal picks"), new Category(1, "Trending"), new Category(2, "Newest")]
  const boxes = [
  ...
  return (
    <div className='flex flex-col items-center justify-between'>
      <div className="flex gap-20 my-12 mx-96">
        <img className='w-48 h-48' src={musical_box} alt="Musical box handrawing" />
        <div className="flex flex-col flex-grow max-w-md justify-center gap-4">
          <h1>More than sound</h1>
          <p className='text-justify'>Music is an essential part of our lives. Through it we express emotions, share, and bring important moments back to life. Through musical boxes, you can <b>make them tangible.</b></p>
        </div>
      </div>
      <CategoryPicker className="my-6" showChooseText={false} categories={homeCategories} />
      <MusicalBoxGrid className="my-6" boxes={boxes}/>
      <div className="flex justify-end my-12 w-1/2">
        <SecondaryButton text="See the full catalog" trailingIcon={<FaArrowRight/>}/>
      </div>
